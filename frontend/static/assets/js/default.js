                            ...
                            mounted: function () {
                                ...
                                if (
                                    ...
                                    i.datepicker({
                                        ...
                                        minDate: o,
                                        maxDate: "-1d +1y",
                                        nextText: "<span>" + i.attr("data-next-text") + '</span> <i class="icon icon-arrow-right"></i>',
                                    ...
                                    r.datepicker({
                                        ...
                                        minDate: "+0d",
                                        maxDate: "-1d +32d",
                                        nextText: "<span>" + r.attr("data-next-text") + '</span> <i class="icon icon-arrow-right"></i>',
                            ...
                            mounted: function () {
                                ...
                                n.find(".datepickerItem").each(function (n, a) {
                                    t(a).datepicker({
                                        ...
                                        minDate: "-1y",
                                        maxDate: "-1d +1y",
                                        nextText: "<span>" + t(a).attr("data-next-text") + '</span> <i class="icon icon-arrow-right"></i>',
