...
from utils.constants import (SUPER_ADMIN, CUSTOMER, MAHALLE, SUCCESS, REGISTRATION_EMAIL,
                             SUPERADMIN_PASSWORD_RESET_EMAIL, PASSWORD_RESET_EMAIL, CAMPAIGN_EMAIL, ORDER_EMAIL)
...
class UserFactory(GeneralModelFactory):
    class Meta:
        model = User
