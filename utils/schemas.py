        ...
        examples={
            "application/json": {
                ...
                "message": {
                    ...
                    "user": {
                        "id": 18,
                        "username": "vendor@hendeseli.com",
                        "email": "vendor@hendeseli.com",
                        "first_name": "Vendor",
                        "last_name": "Hendeseli",
                        "avatar": None,
                        "phone": None,
                        ...
                        "user_permissions": [],
                        "hendeseli_sms_allowed": True,
                        "hendeseli_email_allowed": True,
                        "hendeseli_phone_allowed": True,
                        "addresses": [],
                        "basket": {
                            "id": 4,
                            "products": [],
...
entegra_category_attributes_schema_dict = {
    400: _("Bad Request"),
    500: _("Internal Server Error"),
    201: openapi.Response(
...
entegra_brand_by_name_schema_dict = {
    400: _("Bad Request"),
    500: _("Internal Server Error"),
    201: openapi.Response(
        description="Category attributes",
        examples={
            "application/json": {
                ...
                "errorType": None,
                "message": None,
                "next_page_url": "http://192.168.1.179/api/v1/categories?page=2",
                "prev_page_url": None,
                "first_page_url": "http://192.168.1.179/api/v1/categories?page=1",
                "last_page_url": "http://192.168.1.179/api/v1/categories?page=449",
                "data": [
                    {
                        "id": 2,
