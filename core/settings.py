...
INSTALLED_APPS = [
    ...
    'attachment.apps.AttachmentsConfig',
    'frontend.apps.FrontendConfig',
    'kampanya.apps.KampanyaConfig',
    'country.apps.CountryConfig',
    'ofis.apps.OfisConfig',
    'araba.apps.ArabaConfig',
    'drf_yasg',
    'rest_framework',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'core_extras': 'frontend.templatetags.car_rental_extras',
...
CACHES = {
    "default": {
        "BACKEND": os.getenv("CHANNEL_LAYERS"),
        "LOCATION": f"""redis://{os.getenv("CHANNEL_LAYERS_HOST")}:{os.getenv("CHANNEL_LAYERS_PORT")}""",
        "TIMEOUT": CACHE_TTL,
        # "OPTIONS": {
        #     "CLIENT_CLASS": "django_redis.client.DefaultClient",
        #     "PASSWORD": os.getenv("CHANNEL_LAYERS_PASSWORD")
        # }
    }
}
...
EMAIL_USE_SSL = os.getenv("EMAIL_USE_SSL") in ["True", True]
...
GOOGLE_JS_MAP_API_KEY = os.getenv("GOOGLE_JS_MAP_API_KEY")
